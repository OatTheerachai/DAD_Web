                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title" style="line-height: 2.1rem">Activity</h3>
                                        
                                    </div>
                                    <div class="card-body">
                                        <table id="dataTable-history" class="table table-hover table-bordered table-striped stripe row-border order-column" width="100%">
                                        </table>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title" style="line-height: 2.1rem">Agency</h3>
                                    </div>
                                    <div class="card-body">
                                        <table id="dataTable-agency" class="table table-hover table-bordered table-striped stripe row-border order-column" width="100%">
                                        </table>
                                    </div>
                                </div>
                            </div>
