...
<body class="hold-transition sidebar-mini">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  Category:
                  <select name="subject" id="catdrop" class="catdrop form-control">
                  ...
                  <br /><br />
                  Building:
                  <select name="topic" id="cat2drop" class="cat2drop form-control">
                    <option value="" selected="selected">
                  ...
                  <table id="mytable" class="table table-hover table-bordered table-striped" style="width: 100%"></table>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="modal fade" id="updateModal" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="../../assets/lib/submitForm/submitUpdateAgency.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <label for="agencid">ID:</label>
              <input name="agencid" id="agencid" value="" class="form-control" readonly />
        ...
        <input id="addbuild" type="button" value="addbuilding" /><br /><br /> -->
            ...
            <div class="container-fluid">
              ...
              <div>
                ...
                <!-- <p>ใส่ได้เพียงรูปเดียว</p>
                  <p>png only</p>
                  <p>ไม่เกิน20mb</p> -->
                <input class="btn btn-danger" id="deletelogoimage" type="button" value="deleteimage" />
              </div>

              <img id="imageshow" src="../../assets/img/logo/default.png" width="200" height="200" />
              <label for="updateimage"> change logo's image: </label>
              <input type="file" accept="image/png, .jpg" name="updateimage" id="updateimage" />
              <br /><br />
            ...
            <div class="modal-footer">
              ...
              <input type="submit" class="btn btn-primary btn-block" name="updatesub" value="update" />
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="modal fade" id="insertModal" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form action="../../assets/lib/submitForm/submitInsertAgency.php" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              <!-- <form
                  target="_blank"
              ...
              <input type="file" accept="image/png, .jpg" name="uploadfile" id="uploadimage" />
              <br /><br />
  ...
  <script src="../../assets/js/catagory/insertAgencyJS.js" charset="UTF-8"></script>
